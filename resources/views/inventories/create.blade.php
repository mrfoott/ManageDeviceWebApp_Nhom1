        ...
        <div class="row">
            <div class="col-12 pt-2">
                ...
                <div class="border rounded mt-5 pl-4 pr-4 pt-4 pb-4">
                    <h1 class="display-4">Create a New Inventories</h1>
                    <p>Fill and submit this form to create a new inventories</p>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="control-group col-12">
                                ...
                                <input type="text" id="nameInventories" class="form-control" name="nameInventories"
                                       placeholder="Enter Inventories Name" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="control-group col-12">
                        ...
                        <div class="row">
                            <div class="control-group col-12">
                                ...
                                <input type="number" id="nameUsers" class="form-control" name="statusUsers"
